 ...
 * See LICENSE in the login directory for license information.
 */
...
import com.app.csulb.rentmybookfinal.Application;
    ...
    public static synchronized AuthenticationManager getInstance() {
        if (INSTANCE == null) {
            ...
            if (mPublicClientApplication == null) {
                mPublicClientApplication = new PublicClientApplication(Application.getInstance());
            }
        }
        return INSTANCE;
    }
